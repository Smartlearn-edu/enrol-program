...
$string['allprograms_badge'] = 'All Programs';
...
$string['continueprogram'] = 'Continue Program';
...
$string['coursesincluded'] = '{$a} courses included';
...
$string['customfieldsettings'] = 'Custom field settings';
$string['customfield_notvisible'] = 'Not visible';
$string['customfield_visibletomanagers'] = 'Visible to managers only';
$string['customfield_visibletoall'] = 'Visible to everyone';
$string['customfield_visibility'] = 'Visibility';
...
$string['noprogramsmatching'] = 'No programs match your search or filter criteria.';
...
$string['sequencetype_studentchoice'] = 'Student choice (Select {$a->min} of {$a->total})';
$string['minprerequisites'] = 'Required courses';
$string['selectcourses'] = 'Select elective courses';
$string['selectncourses'] = 'Please select {$a} courses from the options below to enrol and continue:';
$string['confirmselection'] = 'Confirm Selection';
$string['coursesselected'] = 'Your course selections have been saved successfully.';
$string['coursesselectionreset'] = 'Course selections have been reset.';
$string['errorselectexactcount'] = 'You must select exactly {$a} courses.';
$string['errorinvalidcourse'] = 'One or more selected courses are invalid for this set.';
$string['selected'] = 'Selected';
$string['notselected'] = 'Not selected';
$string['selectedcoursescount'] = '{$a} selected';
$string['selectionrequired'] = 'Selection required';
$string['selectionlocked'] = 'Course selection is currently locked until prerequisites are completed.';
$string['resetselection'] = 'Reset selection';
$string['locked'] = 'Locked';
$string['completionrule'] = 'Completion criterion';
$string['completionrule_courses'] = 'Required number of courses';
$string['completionrule_credits'] = 'Minimum academic credit hours';
$string['completionrule_points'] = 'Minimum gamification points';
$string['completionrule_both_courses_credits'] = 'Both course count and minimum credit hours';
$string['completionrule_both_courses_points'] = 'Both course count and minimum points';
$string['mincredits'] = 'Minimum credit hours';
$string['minpoints'] = 'Minimum points';
$string['credithours'] = 'Academic credit hours';
$string['credithour_singular'] = 'Credit';
$string['credithours_plural'] = 'Credits';
$string['points'] = 'Gamification points';
$string['credithours_badge'] = '{$a} Credits';
$string['points_badge'] = '{$a} pts';
$string['medaltype_trophy'] = 'Trophy';
$string['medaltype_medal'] = 'Medal';
$string['medaltype_merit'] = 'Merit';
$string['medaltype_pass'] = 'Pass';
$string['medaltype_star'] = 'Star';
$string['medaltype_gem'] = 'Gem';
$string['medaltype_coin'] = 'Coin';
$string['rewardscolumn'] = 'Credits & Rewards';
$string['sequencetype_credits_info'] = 'Earn at least {$a->min} credit hours';
$string['sequencetype_credits_info_unit'] = 'Earn at least {$a->min} {$a->unit}';
$string['sequencetype_points_info'] = 'Earn at least {$a->min} points';
$string['sequencetype_points_info_unit'] = 'Earn at least {$a->min} {$a->unit}';
$string['selectcredits'] = 'Please select courses totaling at least {$a} credit hours to enrol and continue:';
$string['selectcredits_unit'] = 'Please select courses totaling at least {$a->amount} {$a->unit} to enrol and continue:';
$string['selectpoints'] = 'Please select courses totaling at least {$a} points to enrol and continue:';
$string['selectpoints_unit'] = 'Please select courses totaling at least {$a->amount} {$a->unit} to enrol and continue:';
$string['errorinsufficientcredits'] = 'Your selection totals {$a->selected} credit hours. You must select at least {$a->required} credit hours.';
$string['errorinsufficientcredits_unit'] = 'Your selection totals {$a->selected} {$a->unit}. You must select at least {$a->required} {$a->unit}.';
$string['errorinsufficientpoints'] = 'Your selection totals {$a->selected} points. You must select at least {$a->required} points.';
$string['errorinsufficientpoints_unit'] = 'Your selection totals {$a->selected} {$a->unit}. You must select at least {$a->required} {$a->unit}.';
$string['totalselectedcredits'] = 'Selected: {$a->credits} Credits ({$a->count} courses)';
$string['totalselectedcredits_unit'] = 'Selected: {$a->credits} {$a->unit} ({$a->count} courses)';
$string['totalselectedpoints'] = 'Selected: {$a->points} Points ({$a->count} courses)';
$string['totalselectedpoints_unit'] = 'Selected: {$a->points} {$a->unit} ({$a->count} courses)';
$string['selectcategory'] = 'Select category';
$string['searchprograms_placeholder'] = 'Find a program...';
$string['showingprograms'] = 'Showing {$a} programs';
